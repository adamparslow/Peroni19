...
selectedFileList.append({"title": "Counterdiabatic mode-evolution based coupled-waveguide devices", "authors": "Shuo-Yen Tseng", "fileName": "oe-21-18-21224.pdf"})
...
selectedFileList.append({"title": "Short and robust directional couplers designed by shortcuts to adiabaticity", "authors": "Shuo-Yen Tseng", "fileName": "oe-22-16-18849.pdf"})
...
selectedFileList.append({"title": "Short and robust silicon mode (de)multiplexers using shortcuts to adiabaticity", "authors": "Tzu-Hsuan Pan", "fileName": "oe-23-8-10405.pdf"})
...
selectedFileList.append({"title": "Fast and robust quantum control for multimode interactions using shortcuts to adiabaticity", "authors": "H. Zhang", "fileName": "oe-27-5-7384.pdf"})
...
selectedFileList.append({"title": "Fast and robust population transfer in two-level quantum systems with dephasing noise and/or systematic frequency errors", "authors": "Xiao-Jing Lu", "fileName": "PhysRevA.88.033406.pdf"})
